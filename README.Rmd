...
This repository contains the R code used in this experiment. The following folders conain: 
...
*[data/](data/): Preprocessed and/or cleaned datasets used in the this chapter

Due to size constraints, some raw data is not included in this repositry and as such, the following scripts are deprecated:
...
#### Contact
I can be contacted via [email](brgordon17@gmail.com) at brgordon17@gmail.com
